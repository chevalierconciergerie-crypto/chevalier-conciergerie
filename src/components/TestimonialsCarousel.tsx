...
// Les avis vivent dans src/data/avis.ts, partagés avec le ruban de l'accueil.
import { avis as testimonials, GOOGLE_REVIEWS_URL, type Avis as Testimonial } from "@/data/avis";
