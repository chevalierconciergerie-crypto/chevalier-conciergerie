...
Retrait du consentement : contact@chevalier-conciergerie.com`
    },
    {
      id: "stockage",
      icon: Lock,
...
Contact : contact@chevalier-conciergerie.com
          ...
          <div className="mt-20 text-center">
            <div className="inline-block px-6 py-3 rounded-full bg-background border border-border/50">
              <p className="font-sans text-sm text-muted-foreground">
                ...
                <a href="mailto:contact@chevalier-conciergerie.com" className="text-gold hover:underline ml-1">
                  Questions ?
                </a>
              </p>
            </div>
